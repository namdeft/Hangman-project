...
void Menu::setName(string n) { this->name = n; }

string Menu::getDescription() { return this->description; }

void Menu::setDescription(string d) { this->description = d; }

int Menu::getAction() { return action; }

void Menu::setAction(int a) { this->action = a; }

void Menu::addSubMenu(Menu *m) { this->subMenu.push_back(m); }
